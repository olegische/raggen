...
- [ ] Обновить схему Prisma для документов и чанков
  - [ ] Создать модель Document
    - [ ] Поля: id, name, type, size, content, createdAt, updatedAt
    - [ ] Тестирование миграции
    - [ ] Тестирование CRUD операций
  - [ ] Создать модель Chunk
    - [ ] Поля: id, documentId, content, embedding, metadata, createdAt
    - [ ] Тестирование миграции
    - [ ] Тестирование CRUD операций
  - [ ] Настроить связи между моделями
    - [ ] Тестирование связей
- [ ] Добавить компоненты загрузки файлов
  - [ ] Создать компонент FileUpload
