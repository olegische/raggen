...
- [x] Настроить базовое отображение документов
  - [x] Создать компонент DocumentList
    - [x] Отображение списка документов
    - [x] Пагинация
    - [x] Сортировка
    - [x] Тестирование отображения
  - [-] ~~Создать компонент DocumentView~~ (перенесено в релиз 2.1)
...
- [x] Настроить связи с существующими таблицами
  - [x] Связь Document с Embedding
  - [x] Связь Document с Context
  - [x] Обновить EmbeddingRepository для работы с новыми связями

## 2. Разработка функционала документов

### 2.1. Векторизация абзацев
- [x] Реализовать разделение на абзацы
  - [x] Правила разделения текста
  - [x] Сохранение контекста
  - [x] Настройки размера абзаца
  - [x] Конфигурация перекрытия
- [x] Создать систему агрегации эмбеддингов
  - [x] Методы агрегации (среднее, взвешенное)
  - [x] Оптимизация памяти
  - [x] Параллельная обработка
- [x] Оптимизация памяти для больших текстов
  - [x] Потоковая обработка
