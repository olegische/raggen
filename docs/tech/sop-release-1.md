...
- [x] Создат�� форматтер промптов с контекстом
...
- [x] Настроить локальное окружение для обоих сервисов
...
- [ ] Создать документацию по основным функциям
  - [ ] Описать работу с чатом
  - [ ] Описать выбор моделей
  - [ ] Описать настройку контекста
  - [ ] Описать управление историей
...
- [ ] Создать документацию по работе с контекстом
  - [ ] Объяснить принципы работы контекста
  - [ ] Описать настройку релевантности
  - [ ] Добавить примеры использования
- [ ] Создать документацию по провайдерам
  - [ ] Описать особенности каждого провайдера
  - [ ] Добавить сравнение моделей
  - [ ] Добавить рекомендации по выбору
- [ ] Создать FAQ
  - [ ] Собрать частые вопросы
  - [ ] Описать типичные проблемы и решения
  - [ ] Добавить советы и рекомендации
- [ ] Создать глоссарий
  - [ ] Добавить основные термины
  - [ ] Добавить сокращения
