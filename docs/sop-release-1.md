...
- [ ] Написать тесты для клиента и сервиса
...
- [ ] Написать тесты для поиска контекста
- [ ] Протестировать форматирование промптов
...
- [ ] Протестировать интерактивность
...
- [ ] Потребление памяти FAISS в пределх нормы
